...
def runPipeline(image: cv2.typing.MatLike, llrobot) -> tuple:
    """
    The function that is called every frame by Limelight's backend.

    Args:
        image: The current camera image as a cv2 MatLike object.
        llrobot: A number (double) array that can be used to send data from the robot.
    """
